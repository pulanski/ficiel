# NOTE: This file comes from the Carbon Language project (used to setup portability
# of build and test environments). User needs only docker on their system to build and test
# the project.
...
# Run the ficiel main binary.
RUN bazel run //ficiel:main
